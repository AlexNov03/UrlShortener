...
// Source: internal/usecase/urlusecase.go
...
// GetShortUrlByLong mocks base method.
func (m *MockUrlRepository) GetShortUrlByLong(ctx context.Context, longUrl string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetShortUrlByLong", ctx, longUrl)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetShortUrlByLong indicates an expected call of GetShortUrlByLong.
func (mr *MockUrlRepositoryMockRecorder) GetShortUrlByLong(ctx, longUrl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetShortUrlByLong", reflect.TypeOf((*MockUrlRepository)(nil).GetShortUrlByLong), ctx, longUrl)
}
